...
RestWrite.prototype.handleInstallation = function () {
  ...
  var installationId = this.data.installationId || this.auth.installationId;
  ...
  promise = promise.then(function () {
    ...
    if (_this9.query && _this9.query.objectId) {
      ...
      if (installationId && objectIdMatch.installationId && installationId !== objectIdMatch.installationId) {
